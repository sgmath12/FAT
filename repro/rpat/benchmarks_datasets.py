...
# 2026-09-16: read the dataset root from the environment so the CIFAR copies FAT already downloaded
# can be reused (torchvision expects <root>/cifar-10-batches-py); '' keeps the upstream default.
DATA_PATH = os.environ.get('RPAT_DATA_PATH', '')
