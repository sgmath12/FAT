...
class AttackerPolymer:
    ...
    def AA(self, model, img, gt, attacks_to_run=None, return_acc=False, norm='Linf'):
        try:
        ...
        #####
        adversary = AutoAttack(model, norm=norm, eps=self.epsilon, version='standard', verbose=False)
        if attacks_to_run:
