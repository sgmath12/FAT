# Verbatim copy of FAT/CIFAR10/models/resnet.py, so RPAT++ can be trained on exactly the
# same ResNet-18 (post-activation, BN in the shortcut) that our own experiments use,
# instead of the PreActResNet-18 of the RPAT paper.
import torch
