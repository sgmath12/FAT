#!/usr/bin/env bash
# 2026-09-16 21:20.  Replaces chain_rpatawp2_20260916.sh (killed while the natural-init CIFAR-100
...
for entry in CIFAR10:cfa_nostack_eps8_50ep CIFAR10:cfa_nostack_eps88_50ep \
