...
### 5.8 Snapshot: the tables that currently carry blue cells in `4_Experiments.tex` (2026-09-16)
...
Copied verbatim from the tex (the §5.2–5.5 tables above hold the older published-number draft and are



left untouched). *Italic* = `\textcolor{blue}` in the tex, i.e. measured in this framework and



pending audit (promoted to plain once audited); **bold** = ours / row best; plain = audited.



New since the weekend: `tab:tin`'s ARREST row and `tab:wrn`'s *CFA + WA (no AWP)* row, both landed



09-16 (the wrn_champ_wa and arrest_20ep chains); the four 50-epoch `wrn_champ_wa` cells are still



evaluating and are in no table yet.
...
**Table 2 (`tab:main`).** Main results. ResNet-18, $\ell_\infty$, $\epsilon = 8/255$, final-epoch



weight-averaged model, AutoAttack throughout.
...
| Method | T. | C10 Clean | AA | Avg | NRR | C100 Clean | AA | Avg | NRR | note |
...
| PGD-AT | — | *84.54* | *43.57* | *64.06* | *57.50* | — | — | — | — | other machine |



| TRADES | — | *81.71* | *49.16* | *65.44* | *61.39* | — | — | — | — | other machine |



| MART | — | *80.41* | *45.56* | *62.99* | *58.16* | — | — | — | — | other machine |



| Consistency-AT | — | *84.92* | *43.64* | *64.28* | *57.65* | — | — | — | — | other machine |
...
| LBGAT | nat. | — | — | — | — | 56.46 | 26.02 | 41.24 | 35.62 | *C10 collapsed* |



| ARREST | nat. | *85.06* | *46.42* | *65.74* | *60.06* | *66.97* | *22.78* | *44.88* | *34.00* | |
...
| ADR | self | *83.36* | *49.72* | *66.54* | *62.29* | — | — | — | — | other machine |
...
**Table 3 (`tab:tin`).** Tiny-ImageNet-200, ResNet-18. Same rows and protocol as tab:main
...
| TRADES | — | *46.98* | *15.95* | *31.47* | *23.83* |



| MART | — | *46.01* | *16.90* | *31.45* | *24.73* |



| Consistency-AT | — | *49.64* | *14.39* | *32.02* | *22.31* |
...
| AdaAD + IGDM | nat. | — | — | — | *collapsed* |



| LBGAT | nat. | *51.04* | *18.47* | *34.76* | *27.13* |



| ARREST | nat. | *59.38* | *16.06* | *37.72* | *25.28* |
...
| ADR | self | *47.66* | *20.85* | *34.26* | *29.01* |
...
**Table 4 (`tab:wrn`).** WideResNet-34-10, $\ell_\infty$, $\epsilon = 8/255$. Same rows and protocol



as `tab:main`. **CFA (ours)** is the shipped recipe (CFA+WA+AWP); *CFA + WA (no AWP)* is the same



recipe with the AWP proxy disabled ($\gamma = 0$); both train at radius $8.8/255$, all accuracy at
...
| Method | T. | C10 Clean | AA | NRR | C100 Clean | AA | NRR |
...
| PGD-AT | — | *86.00* | *45.71* | *59.69* | *58.97* | *22.84* | *32.93* |



| TRADES | — | *85.13* | *48.99* | *62.19* | *57.35* | *25.60* | *35.40* |



| MART | — | *85.29* | *47.06* | *60.65* | *57.16* | *22.43* | *32.22* |



| Consistency-AT | — | — | — | — | *59.42* | *23.28* | *33.45* |



| ARD | nat. | *86.35* | *45.52* | *59.61* | *59.52* | *23.05* | *33.25* |



| RSLAD | nat. | *86.41* | *45.80* | *59.87* | *60.48* | *21.63* | *31.87* |



| AdaAD | nat. | *86.80* | *46.84* | *60.85* | *61.66* | *25.62* | *36.20* |
...
| LBGAT | nat. | *81.56* | *51.79* | *63.35* | *59.63* | *28.55* | *38.61* |



| ARREST | nat. | *87.54* | *48.83* | *62.69* | *67.69* | *24.69* | *36.18* |



| HAT | nat. | *87.15* | *53.21* | *66.07* | *62.81* | *26.91* | *37.68* |



| ADR | self | *88.64* | *52.34* | *65.82* | *65.05* | *29.04* | *40.15* |
...
| CFA + WA (no AWP) | nat. | *86.38* | *50.42* | *63.67* | *59.89* | *25.89* | *36.15* |
