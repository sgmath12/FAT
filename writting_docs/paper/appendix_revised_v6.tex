...
\begin{table}[!htbp]
  ...
  \begin{tabular}{lrrr}
    ...
    \(\Phi_t(x_{\rm adv})\) & \textbf{76.11} & 0.00 & 0.00 \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{llrrrr}
    ...
    --      & \checkmark  & \textbf{65.01} & 27.62 & \textbf{46.32} & \textbf{38.77} \\
    \checkmark  & --      & 63.54 & 26.75 & 45.14 & 37.65 \\
    \checkmark  & \checkmark  & 63.89 & \textbf{27.78} & 45.84 & 38.72 \\
    \midrule
    \multicolumn{6}{l}{\emph{$\epsilon_{\mathrm{train}}=8.8/255$}} \\
    --      & --      & 63.09 & 25.74 & 44.41 & 36.56 \\
    --      & \checkmark  & \textbf{63.11} & 27.97 & 45.54 & 38.76 \\
    \checkmark  & --      & 62.30 & 27.69 & 44.99 & 38.34 \\
    \checkmark  & \checkmark  & 62.17 & \textbf{28.86} & \textbf{45.52} & \textbf{39.42} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{llrrrrrr}
    ...
    \midrule
    CIFAR-100 & CFA, head frozen (100 ep.)   & 62.17 & 36.91 & 32.37 & 30.93 & 28.86 & 39.42 \\
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{llrrrrl}
    ...
    Generalist++              & co-tr.  & 62.97 & 23.96 & 43.47 & 34.71 & \citet{generalist} \\
    ...
    Generalist++              & co-tr.  & 89.09 & 46.07 & 67.58 & 60.73 & \citet{generalist} \\
