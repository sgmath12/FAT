...
\begin{table}[h]
  ...
  \caption{Tiny-ImageNet-200, ResNet-18. Every row is measured in this framework under the protocol of \Cref{tab:main}; \textbf{--} marks a cell we have not run yet. Our row uses the 200-epoch teacher; the 80-epoch teacher gives $57.08 / 18.96$ (NRR $28.46$), which is the teacher-length dial of \Cref{tab:teacherladder} on a third dataset.}
  \label{tab:tin}
  \begin{tabular}{llrrrr}
    ...
    RPAT++                           & --    & -- & -- & -- & -- \\
    \midrule
    \textbf{CFA (ours)}              & nat.  & 55.16 & 20.54 & 37.85 & 29.93 \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[h]
  \centering \small \setlength{\tabcolsep}{4.5pt}
  \caption{CIFAR-10, WideResNet-34-10. Every row is measured in this framework under the protocol of \Cref{tab:main}; \textbf{--} marks a cell we have not run yet. Our row is in progress.}
  \label{tab:w10}
  \begin{tabular}{llrrrr}
    \toprule
    Method & Teacher & Clean & AA & Avg & NRR \\
...
\begin{table}[h]
  \centering \small \setlength{\tabcolsep}{4.5pt}
  \caption{CIFAR-100, WideResNet-34-10. Every row is measured in this framework under the protocol of \Cref{tab:main}; \textbf{--} marks a cell we have not run yet. Our row is in progress. The comparison line here is ADR's WideResNet-34-10 result, $62.21$ clean / $31.60$ AA (\Cref{tab:published}).}
  \label{tab:w100}
  \begin{tabular}{llrrrr}
    \toprule
    Method & Teacher & Clean & AA & Avg & NRR \\
