...
\paragraph{ARREST} uses its published 20-epoch recipe in \Cref{tab:baselinestack}. The main table
instead uses 150 epochs, AdamW, WA, and AWP to compare its objective with CFA under the longer
training stack; ARREST retains a uniform radius. Both versions start from the same natural teacher.
