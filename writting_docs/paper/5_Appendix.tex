...
\begin{table}[t]
  ...
  reported. Our row is strictly above all of them on both axes, and above all fourteen rows that are the same network as ours. ADR trains this dataset for $80$
  ...
  LBGAT reports this dataset without AutoAttack and B-MTARD reports it on MobileNet-v2, so neither
  appears; CURE, ARREST and Generalist++ report it not at all.}
  ...
  \begin{tabular}{lrrrrl}
    ...
    HAT                        & 52.60 & 18.14 & 35.37 & 26.98 & ADR \\
    TE                         & 47.46 & 18.29 & 32.88 & 26.40 & ADR \\
    AT                         & 45.87 & 18.06 & 31.96 & 25.92 & ADR \\
    TRADES                     & 48.49 & 17.35 & 32.92 & 25.56 & ADR \\
    \midrule
    \multicolumn{6}{l}{\emph{not comparable with the block above --- see caption}} \\
