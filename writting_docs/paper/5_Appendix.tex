...
\begin{table}[t]
  ...
  reported. Our row is strictly above all of them on both axes. ADR trains this dataset for $80$
  epochs against our $100$, which favours us and is stated here rather than left implicit. Rows from
  F\textsuperscript{2}AT are separated because they are not comparable: its plain SAT baseline reaches
  $31.52/9.37$ where ADR's plain AT reaches $45.87/18.06$, a gap no difference of method explains.
