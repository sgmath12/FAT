...
$\ell_1$ norm, and the shipped recipe uses $\ell_2$: the cell that fixed the recipe used it, and every
logged run since had to stay reproducible against that choice. The two are not the same allocation.
