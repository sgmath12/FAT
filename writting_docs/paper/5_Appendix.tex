...
\subsection{Measurements of Feature Fidelity and Variation}
\label{app:anchor_measurements}

On CIFAR-100 over $\epsilon=8/255$ balls, the measured anchor and clean discrepancy are $L=7.58$
and $F=6.30$. The measured student variation is a lower bound $O_{\mathrm{lb}}=2.16$, compared
with a teacher variation measurement of $6.68$ on the same balls. These observations indicate less
student feature variation under the evaluated perturbations, together with a remaining clean
discrepancy from the teacher. A lower bound on $O$ cannot establish worst-case stability or show
that fidelity dominates the exact anchor at convergence.
