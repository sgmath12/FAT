...
\paragraph{ARREST} runs its published recipe in both tables: adversarial finetuning for 20 epochs from
the natural model with SGD at $0.025$, the angular representation term at $\lambda = 50$, and Noisy
Replay over the first half at $\phi = 30^\circ$.
