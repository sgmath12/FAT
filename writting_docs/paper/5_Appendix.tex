...
\Cref{tab:controls} is therefore read against the stronger of its two rows. AdaAD loses $1.31$ NRR
when given our recipe, so the recipe is not a general improvement that the baselines were denied.
